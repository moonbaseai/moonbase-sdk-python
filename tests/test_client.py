...
class TestMoonbase:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = Moonbase(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Moonbase) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.program_messages.with_streaming_response.create(
                person={"email": "person-12@example-12.com"}, program_template_id="1CRMPDbi5U9joyZVuMZo78"
            ).__enter__()
...
class TestAsyncMoonbase:
    ...
    def test_base_url_trailing_slash(self, client: AsyncMoonbase) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMoonbase) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMoonbase) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncMoonbase(base_url=base_url, api_key=api_key, _strict_response_validation=False)
