...
class TestInboxes:
    ...
    def test_raw_response_list(self, client: Moonbase) -> None:
        response = client.inboxes.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Moonbase) -> None:
        with client.inboxes.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncInboxes:
    ...
    async def test_raw_response_list(self, async_client: AsyncMoonbase) -> None:
        response = await async_client.inboxes.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncMoonbase) -> None:
        async with async_client.inboxes.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
