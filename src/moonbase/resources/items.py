...
from ..types import item_search_params
...
from ..types.item_search_response import ItemSearchResponse
...
class ItemsResource(SyncAPIResource):
    ...
    def search(
        ...
        *,
        query: str,
        filter: item_search_params.Filter | Omit = omit,
        ...
        Args:
          ...
          filter: Filter results by one or more collection IDs or `ref` values.
