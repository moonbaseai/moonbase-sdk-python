...
class InboxMessagesResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        conversation_id: inbox_message_list_params.ConversationID | Omit = omit,
        inbox_id: inbox_message_list_params.InboxID | Omit = omit,
        limit: int | Omit = omit,
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
...
class InboxMessagesResourceWithRawResponse:
    ...
    def attachments(self) -> AttachmentsResourceWithRawResponse:
        """Manage your inboxes, conversations, and messages"""
        return AttachmentsResourceWithRawResponse(self._inbox_messages.attachments)
...
class AsyncInboxMessagesResourceWithRawResponse:
    ...
    def attachments(self) -> AsyncAttachmentsResourceWithRawResponse:
        """Manage your inboxes, conversations, and messages"""
        return AsyncAttachmentsResourceWithRawResponse(self._inbox_messages.attachments)
...
class InboxMessagesResourceWithStreamingResponse:
    ...
    def attachments(self) -> AttachmentsResourceWithStreamingResponse:
        """Manage your inboxes, conversations, and messages"""
        return AttachmentsResourceWithStreamingResponse(self._inbox_messages.attachments)
...
class AsyncInboxMessagesResourceWithStreamingResponse:
    ...
    def attachments(self) -> AsyncAttachmentsResourceWithStreamingResponse:
        """Manage your inboxes, conversations, and messages"""
        return AsyncAttachmentsResourceWithStreamingResponse(self._inbox_messages.attachments)
